...
export const courses = [
    {
        ...
        slug       : 'portao-pivotante',
        description: 'Alumínio Premium Super-25 210x120cm',
        category   : 'composto',
        duration   : 10,
        totalSteps : 12,
    ...
    },
    {
        ...
        title      : 'Chapa de Ferro Xadrez',
        slug       : 'chapa-de-ferro-xadrez',
        description: 'Aço Carbono 1020 Preto, espessura: 4,75 mm, Largura: 1200 mm',
        category   : 'material',
        duration   : 30,
        totalSteps : 300,
    ...
    },
    {
        ...
        title      : 'Guarnição para Porta Pivotante',
        slug       : 'guarnicao-para-porta-pivotante',
        description: 'Alumifort 216x110cm Branca',
        category   : 'normal',
        duration   : 45,
        totalSteps : 11,
